...
const IconFacebook: React.FC = () => (
  <span className="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-foreground transition duration-200 ease-in-out hover:scale-110">
    <svg
...
const IconPhone: React.FC = () => (
  <span className="[&>svg]:h-7 [&>svg]:w-7   transition duration-200 ease-in-out hover:scale-110">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="currentColor"
...
export { IconFacebook, IconLinkedin, IconInstagram, IconPhone };
